...
@Slf4j
@Component("GetCourseWorkClassroom::Class")
public class GetCourseWorkClassroom implements GetCourseWork {

    private final Classroom classroom;
    private final ClassroomMaterialToCourseMaterialMapper classroomMaterialToCourseMaterialMapper;

    public GetCourseWorkClassroom(Classroom classroom, ClassroomMaterialToCourseMaterialMapper classroomMaterialToCourseMaterialMapper) {
